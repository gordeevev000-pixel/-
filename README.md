...
* [`pine/DOJI_MTF.pine`](pine/DOJI_MTF.pine) — доджи «стрекоза» и «надгробие» на 1/5/15/30/60 минутах
  одновременно, с панелью, метками и алертами на любом открытом графике.
  Описание: [`pine/DOJI_MTF.md`](pine/DOJI_MTF.md).
